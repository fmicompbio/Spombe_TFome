...
Using bound peaks for each TF (without "common peaks (ubiquitous)"), we
want to measure the distance of peak mid-points to the nearest TSS, using
negative distances to indicate TF binding upstream of the TSS.

```{r peak-mid-to-tss-dist, fig.width=7, fig.height=5}
