...
genomeplot <- cowplot::plot_grid(plotlist = plotList, ncol = 1)
```
...
g1b <- ggplot(plotdf_rna, 
    ...
    scale_fill_manual(values = c(wt = lighten("black", amount = 0.4), 
                                 "ntu1\U141E" = lighten(main_colors[5], amount = 0.4), 
                                 "ntu2\U141E" = lighten(main_colors[1], amount = 0.4))) + 
...
fig7c <- wrap_plots(maplots, ncol = 1) | corrplot[[1]]
