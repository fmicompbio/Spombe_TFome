...
params:
    ...
    coords150: "data/visnetwork_coords_150_new.csv"
    rds500: "data/ipms_500_sce.rds"
    coords500: "data/visnetwork_coords_500_new.csv"
...
ft <- flextable(rad24_rad25_tbl) |>
  width(width =  c(0.5, 1.25)) |>
  set_table_properties(layout = "fixed")
ggtbl <- ggplot() +
    theme_void() +
    annotation_custom(grid::rasterGrob(as_raster(ft)),
...
cowplot::plot_grid(
    ...
    cowplot::plot_grid(fig6c, ggrad_upset,
                       nrow = 1, labels = c("C", "D")), 
    rel_heights = c(5, 2), 
    ncol = 1
)
