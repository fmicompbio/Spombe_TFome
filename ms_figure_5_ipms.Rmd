...
famtbl <- table(baitdata_150$nbrIntMat |>
                    filter(dbdfam != "Other" & 
                               bait != "Untagged") |>
                    pull(dbdfam))
nbait <- sum(baitdata_150$nbrIntMat$bait != "Untagged")
(exp_same <- sum(famtbl * (famtbl - 1)) / (nbait * (nbait - 1)))

## Pie chart, within-vs-between DBD family interactions
pie_data_150 <- baitdata_150$nbrIntMat |>
...
pie_bait_150 <- ggplot(
    ...
    geom_segment(x = 1.55, xend = 1.55, 
                 y = 0, yend = exp_same * sum(pie_data_150$nbrTF),
                 linewidth = 1.5) + 
...
```{r}
## Expected fraction of 'same family' pairs
famtbl <- table(baitdata_150_loose$nbrIntMat |>
                    filter(dbdfam != "Other" & 
                               bait != "Untagged") |>
                    pull(dbdfam))
nbait <- sum(baitdata_150_loose$nbrIntMat$bait != "Untagged")
(exp_same <- sum(famtbl * (famtbl - 1)) / (nbait * (nbait - 1)))

## Pie chart, within-vs-between DBD family interactions
pie_data_150_loose <- baitdata_150_loose$nbrIntMat |>
    filter(bait != "Untagged") |>
    select(nbrTFs_samefam, nbrTFs_difffam) |>
    pivot_longer(everything(), names_to = "class", values_to = "nbrTF") |>
    group_by(class) |>
...
pie_bait_150_loose <- ggplot(
    ...
    geom_col(width = 1) + 
    geom_segment(x = 1.55, xend = 1.55, 
                 y = 0, yend = exp_same * sum(pie_data_150_loose$nbrTF),
                 linewidth = 1.5) + 
    coord_polar("y", start = 0) + 
    scale_fill_manual(values = c(nbrTFs_samefam = main_colors[3],
                                 nbrTFs_difffam = main_colors[5]),
...
```{r}
## Expected fraction of 'same family' pairs
famtbl <- table(baitdata_500$nbrIntMat |>
                    filter(dbdfam != "Other" & 
                               bait != "Untagged") |>
                    pull(dbdfam))
nbait <- sum(baitdata_500$nbrIntMat$bait != "Untagged")
(exp_same <- sum(famtbl * (famtbl - 1)) / (nbait * (nbait - 1)))

## Pie chart, within-vs-between DBD family interactions
pie_data_500 <- baitdata_500$nbrIntMat |>
    filter(bait != "Untagged") |>
    select(nbrTFs_samefam, nbrTFs_difffam) |>
    pivot_longer(everything(), names_to = "class", values_to = "nbrTF") |>
    group_by(class) |>
...
pie_bait_500 <- ggplot(
    ...
    geom_col(width = 1) + 
    geom_segment(x = 1.55, xend = 1.55, 
                 y = 0, yend = exp_same * sum(pie_data_500$nbrTF),
                 linewidth = 1.5) + 
    coord_polar("y", start = 0) + 
    scale_fill_manual(values = c(nbrTFs_samefam = main_colors[3],
                                 nbrTFs_difffam = main_colors[5]),
...
```{r}
## Expected fraction of 'same family' pairs
famtbl <- table(baitdata_500_loose$nbrIntMat |>
                    filter(dbdfam != "Other" & 
                               bait != "Untagged") |>
                    pull(dbdfam))
nbait <- sum(baitdata_500_loose$nbrIntMat$bait != "Untagged")
(exp_same <- sum(famtbl * (famtbl - 1)) / (nbait * (nbait - 1)))

## Pie chart, within-vs-between DBD family interactions
pie_data_500_loose <- baitdata_500_loose$nbrIntMat |>
    filter(bait != "Untagged") |>
    select(nbrTFs_samefam, nbrTFs_difffam) |>
    pivot_longer(everything(), names_to = "class", values_to = "nbrTF") |>
    group_by(class) |>
...
pie_bait_500_loose <- ggplot(
    ...
    geom_col(width = 1) + 
    geom_segment(x = 1.55, xend = 1.55, 
                 y = 0, yend = exp_same * sum(pie_data_500_loose$nbrTF),
                 linewidth = 1.5) + 
    coord_polar("y", start = 0) + 
    scale_fill_manual(values = c(nbrTFs_samefam = main_colors[3],
                                 nbrTFs_difffam = main_colors[5]),
